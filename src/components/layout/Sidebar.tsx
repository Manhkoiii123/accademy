...
const Sidebar = () => {
  ...
  return (
    <div className="hidden p-5 border-r border-r-gray-200 bg-white dark:bg-grayDarker dark:border-opacity-10  lg:flex flex-col fixed bottom-0 left-0 h-screen w-[300px]">
